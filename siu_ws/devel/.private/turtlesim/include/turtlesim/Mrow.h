...
struct Mrow_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::turtlesim::Cell_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::turtlesim::Cell_<ContainerAllocator> >> _cells_type;
  _cells_type cells;
